    ...
    <section id="inquiry" className="py-24 px-6 bg-white">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-12">
          <p className="text-trust-600 text-sm font-semibold tracking-widest uppercase mb-3">Contact</p>
          <h2 className="font-serif-jp text-4xl font-bold text-ink mb-4">
            お問い合わせ
          </h2>
        ...
        {submitted ? (
          <div className="bg-trust-50 border border-trust-200 rounded-2xl p-10 text-center">
            <div className="w-12 h-12 rounded-full bg-trust-100 flex items-center justify-center mx-auto mb-4">
              <svg className="w-6 h-6 text-trust-600" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
              </svg>
            </div>
            <p className="font-semibold text-ink text-lg mb-2">メーラーが開きました</p>
            <p className="text-gray-500 text-sm">送信後、担当者より折り返しご連絡いたします。</p>
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                <label className="block text-sm font-medium text-ink mb-1.5">お名前 <span className="text-red-400">*</span></label>
                <input
                  type="text"
                  required
                  value={form.name}
              ...
              <div>
                <label className="block text-sm font-medium text-ink mb-1.5">会社名 / 組織名</label>
                <input
                  type="text"
                  value={form.company}
            ...
            <div>
              <label className="block text-sm font-medium text-ink mb-1.5">メールアドレス <span className="text-red-400">*</span></label>
              <input
                type="email"
                required
                value={form.email}
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-cream text-ink text-sm focus:outline-none focus:ring-2 focus:ring-trust-300 focus:border-transparent transition resize-none"
              />
            </div>
